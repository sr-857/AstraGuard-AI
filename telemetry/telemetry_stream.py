    ...
    if random.random() < 0.10:
        ...
        if fault_type == "power":
            ...
            faulty_state["voltage"] = round(
                faulty_state["voltage"] - random.uniform(0.8, 1.6), 3
            )
            ...
            faulty_state["temperature"] = round(
                faulty_state["temperature"] + random.uniform(10, 18), 3
            )
...
def main() -> None:
    ...
    try:
        while True:
            ...
            output = {"data": telemetry_state, "fault": fault, "timestamp": time.time()}
