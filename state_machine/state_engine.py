...
def decide_action(fault_type: str) -> Tuple[str, str]:
    ...
    action_map = {
        ...
        "unknown": (
            ...
            "Investigate unknown system state"
        )
    }
    
    return action_map.get(fault_type, (SystemState.UNKNOWN.value, "Investigate unknown fault"))
...
class StateMachine:
    ...
    def process_fault(self, fault_type: str, telemetry_data: Optional[Dict] = None) -> Dict[str, any]:
        """
...
def main() -> None:
    ...
    fault_types = ["power_fault", "thermal_fault", "attitude_fault", "sensor_fault", "normal"]
